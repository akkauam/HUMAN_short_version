...
// PIN 7
#define MODE_0_SETUP (   )          SETUP_DIR(DIR_OUTPUT, P6DIR, BIT0)
#define MODE_0_OUTPUT(out)          SETUP_OUT(out, P6OUT, BIT0)

// PIN 8
#define MODE_1_SETUP (   )          SETUP_DIR(DIR_OUTPUT, P6DIR, BIT1)
#define MODE_1_OUTPUT(out)          SETUP_OUT(out, P6OUT, BIT1)
