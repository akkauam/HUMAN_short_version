...
// PIN 74
#define MUX_OUTPUT_ENABLE_SETUP()   SETUP_DIR(DIR_OUTPUT, P9DIR, BIT7)
#define MUX_OUTPUT_ENABLE_OUTPUT(out)   SETUP_OUT(out, P9OUT, BIT7)
...
// PIN 90
#define FLASH_SELECT_N_SETUP()      SETUP_SEL(SELECT_PERIPHERAL_1, P5SEL0, P5SEL1, BIT7)
